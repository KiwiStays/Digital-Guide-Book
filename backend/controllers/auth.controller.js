...
export const verifyOTP = async (req, res) => {
  ...
  try {
    ...
    const property = await Propertymodel.findById(guest.place_id).select('active');
    const property_active = property.active;
    // console.log("Property active status:", property_active);
    ...
    // console.log("active", property_active);
  } catch (err) {
